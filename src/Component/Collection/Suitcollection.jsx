...
import { suit } from "./suit";  // Your products data
...
const Suitcollection = () => {
    ...
    useScrollToTop();
    const { addToCart } = useCart();  // Accessing addToCart from context
    ...
    const filteredProducts = suit.filter((product) => {
        if (inStock && !outStock) {
                ...
                <div className="LeftSide col-lg-3 col-sm-12 col-md-12">
                    ...
                    <div className="filter pt-5">
                        ...
                        <label htmlFor="outstock" className="fs-5">
                            ...
                            />
                            <span className="ps-2">Out of Stock</span>
                        </label>
                    </div>
                </div>
